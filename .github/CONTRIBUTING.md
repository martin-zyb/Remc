Contributing to Remc!
======================

Thanks for your interest in contributing to Remc! :tada: We love getting [pull requests](https://www.quora.com/GitHub-What-is-a-pull-request) for bugfixes and contributions of our community to keep Remc growing.
...
You've created a new fix or feature for Remc. Awesome!

1. If you haven't already, create a fork of the Remc repository.
