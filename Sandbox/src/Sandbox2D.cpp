...
void Sandbox2D::OnUpdate(Remc::Timestep ts)
{
...

	{
		...
		Remc::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckerboardTexture, 10.0f);
		Remc::Renderer2D::DrawRotatedQuad({ 0.75f, 0.75f, 0.0f }, { 1.0f, 1.0f }, rotation, m_CheckerboardTexture, 20.0f);
