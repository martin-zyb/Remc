...
namespace Remc
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY : should eventually use Remc codes
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseButtonPressedEvent>(REMC_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonPressedEvent));
		dispatcher.Dispatch<MouseButtonReleasedEvent>(REMC_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleasedEvent));
		dispatcher.Dispatch<MouseMovedEvent>(REMC_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
